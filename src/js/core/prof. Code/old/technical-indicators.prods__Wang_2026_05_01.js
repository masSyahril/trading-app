...
windows.BBI3=BBI3;  //將BBI3函數放在windows物件中，方便在其他地方調用。
//----------------------------------------------------------------------
...
windows.BBI4=BBI4;  //將BBI4函數放在windows物件中，方便在其他地方調用。
//----------------------------------------------------------------------
...
windows.BBI5=BBI5;  //將BBI5函數放在windows物件中，方便在其他地方調用。
//----------------------------------------------------------------------
...
function KeltnerChannels(K_high, K_low, K_close, esp1) {
  ...
  const TR=[];  //TR=真實波幅(True Range),TR是陣列不是變數
  let temp1, temp2, temp3;
  let esp1=10;  //exponential smoothing parameter(esp)
  for(let i=2; i<=K_close.length; i++) {  //i=2 to 2000
